...
const caseStudies = [
  ...
  },
  {
    ...
    period: "블록체인 해커톤 콘솔 개발 · 2025.02 ~ 2026.03",
    problem:
      "블록체인 스마트컨트랙트마다 파라미터 개수와 타입(주소, 정수, 문자열, 배열 등)이 제각각이라, 폼을 고정 구조로 만들 수 없었습니다. 신규 컨트랙트가 추가될 때마다 프론트엔드 코드를 수정·배포하지 않아도 되려면, 처음부터 동적으로 폼을 구성하는 구조가 필요했습니다. 여기에 intArray 같은 복합 타입은 입력값 유효성 검증까지 함께 다뤄야 했습니다.",
    decision:
